...
<div id="main" class="noMainPage">
	...
	<p>
	    <a href="dados_pub.php" class="anostyle1">Apresentação</a></br></br>
		<a href="dados_pub.php" class="anostyle1">Dados da publicação</a></br>
	</p>
...
<?php
		    ...
		    $res_boletim = mysql_query($sql_boletim);
		    
		    $class=true;
			
			$lin = array();
		    while ($res_boletim_array = mysql_fetch_array($res_boletim))
		    {
