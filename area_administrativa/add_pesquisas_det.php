	  ...
	  $res = mysqli_query($conn, $strsql) or die(mysqli_error($conn)); 	
		...
		if ($res && mysqli_num_rows($res)>0)
		  ...
		  if ($pesquisa_id!='')
			...
			$pesquisa_ano = '';
	    	$action = '';
			header("Location: cadastro_pesquisas_antigas.php");
...
<body>
		...
		<fieldset>
			...
			<p>
				...
				<input type="button" value="Cancelar" class="botao_cancelar" onclick="javascript: go_Page('cadastro_pesquisas_antigas.php');"/>
			</p>
