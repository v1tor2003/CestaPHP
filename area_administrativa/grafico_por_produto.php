                ...
                <form action="" method="post" name="form_consultas" >
                    ...
                    <div class="conteudo_pagina_esquerda">
                        ...
                        <p>
                            ...
                            <input type="text" name="data_inicial" id="data_inicial" value="08/2007" onKeyPress="mascara(this,data)" size="6" maxlength="7" /><span class="obrig">*</span>
                            &nbsp;  <span class="letras_form_consultas">at&eacute;</span> &nbsp;
                            <input type="text" name="data_final" id="data_final" value="<?php echo date("m/Y"); ?>" size="6" onKeyPress="mascara(this,data)" maxlength="7" /><span class="obrig">*</span>
                        </p>
                        <p align="center">
...
<script type="text/javascript" language="javascript">
    ...
    {
        var url = 'res_grafico_por_produto.php?';
        ...
        params = 'hcit=' + getSelectedItem() + '&hp=' + prod + "&hdti=" + dt_ini + '&hdtf=' + dt_fim;
        url += params;
