...
<body>
		...
		<div class="caixa_principal">
			...
			<!-- Contedo referente a esta pgina -->
					...
					<h1 id="Mcaption" style="text-align:left">Cadastro de Pre&ccedil;os Por Cidade</h1>
						<table  border="0px" id="link_table_add"  style="width:612px"><tr><td>[<a href="add_coletas.php?pesquisa_id=<?php echo($pesquisa_id);?>" id="link_adicionar" >Adicionar</a>]</td></tr></table>
					
					<?php } ?>
					<?php 
						  	$strsql = "SELECT * FROM tabela_coletas A, tabela_estabelecimentos B,tabela_cidades C,tabela_bairros D WHERE A.pesquisa_id = '".$pesquisa_id."' AND (A.estabelecimento_id = B.estabelecimento_id) AND (B.bairro_id = D.bairro_id) AND (D.cidade_id = C.cidade_id) ORDER BY A.coleta_id";
					...
					?>
					<table cellspacing="0" id="listTable" summary="Tabela de Coletas" style="width:603px;">
					<colgroup>
						<col id="codigo" />
