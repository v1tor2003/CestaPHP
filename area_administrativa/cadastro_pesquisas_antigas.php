	...
	<fieldset style="width:560px; margin-top:0px; padding-right: 0px;">
		...
		<table style="border: 0px;"cellspacing="0" cellpadding="0" id="listTable" summary="Tabela de filtro" >
			...
			<tr>
				...
				<td align="right">
					<select name="operador_filtro" style="width:120px;" size="1">
            <option value="=">= (igual a)</option>
	          ...
	          <option value=">=">&ge; (maior e igual)</option>
				...
				<td align="right" id="valor_filtro" style="width:125px;">
					<input type="text" name="valor_filtro" id="filtro_value" maxlength="15" size="12" value=""/>
				</td>
				<td align="right">
...
?>
			<tr style="background: #FFFFCC; color: #FF0000;">
				<td>
				<h3 class="msg_info_importantes">Dados Importantes </h3>
				&nbsp;&nbsp;&nbsp;O encerramento de uma pesquisa levar&aacute; em considera&ccedil;&atilde;o os seguintes dados:<br /><br />
				&nbsp;&nbsp;&nbsp;Sal&aacute;rio Bruto:&nbsp;<?php echo(formata_numero($salario_valor_bruto)); ?><br />
				&nbsp;&nbsp;&nbsp;Sal&aacute;rio L&iacute;quido:&nbsp;<?php echo(formata_numero($salario_valor_liquido)); ?><br /><br />
				&nbsp;&nbsp;&nbsp;[<a href="cadastro_salario_minimo.php">Alterar Sal&aacute;rio em Uso</a>]<br />
				</td>
			</tr>
			<tr><td>
			<div id="tabela">
				<?php require('lista_pesquisas_n_det.php'); ?>
			 </div>
			 </td>
			 </tr>
			 </table>	
...
<script language="javascript" type="text/javascript">
	...
	function atualiza_tabela(pag)
	{
		...
		url = 'lista_pesquisas_n_det.php?hp='+escape(pag);	
	...
	{
		var url = 'lista_pesquisas_n_det.php';
